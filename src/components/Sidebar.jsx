...
const Sidebar = () => {
  ...
  return (
    <aside
      id="sidebar"
      className="hidden sm:flex flex-col items-center xl:items-start fixed z-30 w-full h-full min-h-full max-w-[88px] xl:max-w-[300px] p-6 px-4 bg-[#7AB0C7] dark:bg-[#245261] border-r-2 border-[#A0C9D7] dark:border-[#1A3A45]"
    >
      {/* Logo */}
      <NavLink
        to="/lessons"
