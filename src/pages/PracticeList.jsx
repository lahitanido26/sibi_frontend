...
const PracticeList = () => {
  ...
  return (
    <section id="PracticeList" className="w-full min-h-screen p-4 md:p-8 text-[#1F2A3A] dark:text-[#F1F5F9] bg-gradient-to-b from-[#C3E9FA] to-[#C0E8D5] dark:from-[#245261] dark:to-[#23423A]">
      <div className="mb-8">
        {/* Page Heading */}
